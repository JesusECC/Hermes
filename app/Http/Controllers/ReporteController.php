...
class ReporteController extends Controller
{
    ...
    public function index()
    {
        ...
        ->join('Detalle_ingresoPF as di','di.idIngreso_PF','=','ip.id')
        ->join('Taller as ta','ta.id','=','idTaller_PF')
        ->select('di.nro_guia_PF','di.codigo_PF','di.codigo_bar','di.colorPF','di.tallaPF','di.cantidadPF','di.idTaller_PF','ta.nombre_taller')
         ->whereDate('ip.fecha_horaPF', '=', Carbon::now()->format('Y-m-d'))
...
public function pdf(){
    ...
    $pdf=PDF::loadView('reportes/pdf',['ingreso2'=>$ingreso2,'reporte2'=>$reporte2,'reporte'=>$reporte,'ingreso'=>$ingreso,'salida'=>$salida,'salida2'=>$salida2]);
