...
class PersonaController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.persona.create',['documento'=>$documento,'estado'=>$estado]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.persona.edit',['persona'=>Persona::findOrFail($id),'trabajador'=>$trabajador,'documento'=>$documento,'estado'=>$estado]);
    }
